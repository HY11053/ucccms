                            ...
                            <div class="x_content">
                                ...
                                <form id="demo-form2" onsubmit="return false;" data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea class="resizable_textarea form-control" placeholder="Copyright © 2017 www.58lingshi.com Corporation, All Rights Reserved 上海莫卡网络科技有限公司 版权所有"></textarea>
                                        </div>
                                    </div>
